...
for sub_idx = 1:n_subj
    ...
    if strcmp(subject,'sub-09') % necessary for segmentation, volumebiascorrect doesn't work
        cfg            = [];
    ...
    % 2. Reslice
    %-----------
    if strcmp(subject,'sub-20')
        cfg_bias        = [];
        cfg_bias.method = 'spm'; % Use SPM's bias correction
        mri_resliced    = ft_volumebiascorrect(cfg_bias, mri_resliced);
    end   
